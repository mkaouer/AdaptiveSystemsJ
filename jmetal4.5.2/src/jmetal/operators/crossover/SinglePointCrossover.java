      ...
      if (PseudoRandom.randDouble() < probability) {
        if ((parent1.getType().getClass() == BinarySolutionType.class) ||
          ...
          for (int i = 0; i < offSpring[0].getDecisionVariables().length; i++) {
            ...
            int crossoverPoint = PseudoRandom.randInt(0 , IntSolutionType.min_rules_size-1);
           Rule parents1;
           Rule parents2;
           //parents1 =  parent1;
          // parents2 =  parent2;
          // MySolution S = new MySolution ();
           ...
           for (int i = 0; i < crossoverPoint; i++) {
        	   parents1 =  parent1.rule().get(i);
        	   parents2 = parent2.rule().get(i);
        	   offSpring[0].rule().set(i, parents2) ;
        	   offSpring[1].rule().set(i, parents1) ;
